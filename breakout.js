 ...
 */
function preload() {
  this.load.image('back', 'assets/images/backdrop.png');
  this.load.image('redp', 'assets/images/particles/redp.png');
  this.load.image('orangep', 'assets/images/particles/orangep.png');
  this.load.image('yellowp', 'assets/images/particles/yellowp.png');
...
function create() {
   ...
   */
this.add.image( 400 , 320, 'back')

var rparticles = this.add.particles('redp');
var oparticles = this.add.particles('orangep');
var yparticles = this.add.particles('yellowp');

var remitter = rparticles.createEmitter({
  speed: 25,
  scale: { start: 1.5, end: 0 },
  blendMode: 'ADD'
});

var oemitter = oparticles.createEmitter({
  speed: 50,
  scale: { start: 1, end: 0 },
  blendMode: 'ADD'
});

var yemitter = yparticles.createEmitter({
  speed: 75,
  ...
  player.setCollideWorldBounds(true).setScale(2);
  ...
  remitter.startFollow(ball);
  yemitter.startFollow(ball);
  oemitter.startFollow(ball);
}
